...
@EnableGlobalMethodSecurity(
        securedEnabled = true,  //cho phép dùng @Secured
        jsr250Enabled = true,    //cho phép dùng @RolesAllowed
        prePostEnabled = true   //cho phép dùng @PreAuthorize, @PostAuthorize, @PreFilter, @PostFilter
)
